...
export type GesturePriority = 'COLLAPSE' | 'CAST' | 'LOCK' | 'ROTATE' | 'TARGET' | 'SPACE' | 'HOVER';

export class GesturePriorityResolver {
  resolve(options: { fist: boolean; spellStage: SpellCastStage; motion: MotionState; locking: boolean; rotating: boolean; pointing: boolean; spaceGesture: boolean }): GesturePriority {
